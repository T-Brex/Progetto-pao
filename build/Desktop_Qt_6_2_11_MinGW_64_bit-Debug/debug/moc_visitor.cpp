...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Visitor_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject Visitor::staticMetaObject = { {
    ...
    qt_meta_stringdata_Visitor.offsetsAndSizes,
    qt_meta_data_Visitor,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Visitor_t
