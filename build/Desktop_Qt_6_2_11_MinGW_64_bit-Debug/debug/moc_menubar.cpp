...
static const qt_meta_stringdata_MenuBar_t qt_meta_stringdata_MenuBar = {
    {
        ...
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 14),  // "showOpenDialog"
        QT_MOC_LITERAL(44, 11),  // "saveTrigger"
        QT_MOC_LITERAL(56, 11),  // "loadTrigger"
        QT_MOC_LITERAL(68, 16)   // "showDeleteDialog"
    },
    "MenuBar\0changeLayoutTrigger\0\0"
    "showOpenDialog\0saveTrigger\0loadTrigger\0"
    "showDeleteDialog"
};
...
void MenuBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MenuBar::changeLayoutTrigger; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MenuBar::*)();
            if (_t _q_method = &MenuBar::showOpenDialog; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MenuBar::changeLayoutTrigger()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MenuBar::showOpenDialog()
{
