...
struct qt_meta_stringdata_SensorLayoutChooser_t {
    uint offsetsAndSizes[2];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SensorLayoutChooser_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_SensorLayoutChooser_t qt_meta_stringdata_SensorLayoutChooser = {
    {
        QT_MOC_LITERAL(0, 19)   // "SensorLayoutChooser"
    },
    "SensorLayoutChooser"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_SensorLayoutChooser[] = {
...
const QMetaObject SensorLayoutChooser::staticMetaObject = { {
    QMetaObject::SuperData::link<Visitor::staticMetaObject>(),
    qt_meta_stringdata_SensorLayoutChooser.offsetsAndSizes,
    qt_meta_data_SensorLayoutChooser,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SensorLayoutChooser_t
...
void *SensorLayoutChooser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SensorLayoutChooser.stringdata0))
