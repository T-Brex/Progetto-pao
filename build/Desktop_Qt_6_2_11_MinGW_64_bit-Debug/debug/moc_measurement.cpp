...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Measurement_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_Measurement_t qt_meta_stringdata_Measurement = {
    {
        QT_MOC_LITERAL(0, 11)   // "Measurement"
    },
    "Measurement"
};
...
const QMetaObject Measurement::staticMetaObject = { {
    ...
    qt_meta_stringdata_Measurement.offsetsAndSizes,
    qt_meta_data_Measurement,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Measurement_t
