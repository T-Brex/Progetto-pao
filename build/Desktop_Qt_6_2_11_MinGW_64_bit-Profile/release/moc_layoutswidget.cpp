...
struct qt_meta_stringdata_LayoutsWidget_t {
    uint offsetsAndSizes[2];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_LayoutsWidget_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_LayoutsWidget_t qt_meta_stringdata_LayoutsWidget = {
    {
        QT_MOC_LITERAL(0, 13)   // "LayoutsWidget"
    },
    "LayoutsWidget"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_LayoutsWidget[] = {
...
const QMetaObject LayoutsWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QStackedWidget::staticMetaObject>(),
    qt_meta_stringdata_LayoutsWidget.offsetsAndSizes,
    qt_meta_data_LayoutsWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_LayoutsWidget_t
...
void *LayoutsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LayoutsWidget.stringdata0))
