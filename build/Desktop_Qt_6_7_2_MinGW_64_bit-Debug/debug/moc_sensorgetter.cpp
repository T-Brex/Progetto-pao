...
struct qt_meta_stringdata_CLASSSensorGetterENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSensorGetterENDCLASS = QtMocHelpers::stringData(
    "SensorGetter"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSensorGetterENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SensorGetter::staticMetaObject = { {
    QMetaObject::SuperData::link<Visitor::staticMetaObject>(),
    qt_meta_stringdata_CLASSSensorGetterENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSensorGetterENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSensorGetterENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SensorGetter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSensorGetterENDCLASS.stringdata0))
