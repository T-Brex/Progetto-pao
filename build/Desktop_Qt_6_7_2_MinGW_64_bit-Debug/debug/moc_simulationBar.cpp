...
struct qt_meta_stringdata_CLASSSimBarENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSimBarENDCLASS = QtMocHelpers::stringData(
    "SimBar",
    "add",
    "",
    "Sensor*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSimBarENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SimBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSSimBarENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSimBarENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSimBarENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SimBar, std::true_type>,
        // method 'add'
...
void *SimBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSimBarENDCLASS.stringdata0))
